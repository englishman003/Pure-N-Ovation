...
/*            Home Page              */
    ...
    function mobilePortrait(z){
        if(z.matches){
            screen.classList.remove(`gridTabPort`);
            screen.classList.add(`gridMobilePort`);
        }
        else if(z > `500px`){
            screen.classList.remove(`gridMobilePort`);
            screen.classList.add(`gridTabPort`);
        }
    }

    function tabletPortrait(y){
        if(y.matches){
            screen.classList.remove(`gridTabLand`);
            screen.classList.add(`gridTabPort`);
        }
        else if(y > `750px`){
            screen.classList.remove(`gridTabPort`);
            screen.classList.add(`gridTabLand`);
        }
    }

    function tabletLandscape(x){
        if(x.matches){
            screen.classList.remove(`gridDesktop`);
            screen.classList.add(`gridTabLand`);
        }
        else if(x > `1080px`){
            screen.classList.remove(`gridTabLand`);
            screen.classList.add(`gridDesktop`);
        }
    }
    ...
    function desktop(a){
        if(a.matches){
            screen.classList.remove(`gridTabLand`);
            screen.classList.remove(`gridTabPort`);
            // screen.classList.remove(`gridMobileLand`);
            screen.classList.add(`gridDesktop`);
        }
        else if(a > `3000px`){
            screen.classList.remove(`gridDesktop`);
            screen.classList.add(`gridTV`);
        }
    }
    ...
    const a = window.matchMedia("(max-width: 3000px)");
    tabletLandscape(x);
    tabletPortrait(y);
    mobilePortrait(z);
    desktop(a);
    x.addListener(tabletLandscape);
    y.addListener(tabletPortrait);
    z.addListener(mobilePortrait);
    a.addListener(desktop);
