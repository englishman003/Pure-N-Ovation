    ...
    //   Objects
        ...
        /* ------------------- Skills Page Media Queries --------------------- */
            ...
            function mobilePortrait(z){
                if(z.matches){
                    about.classList.remove(`gridTabPort`);
                    about.classList.add(`gridMobilePort`);
                }
                else if(z > `500px`){
                    about.classList.remove(`gridMobilePort`);
                    about.classList.add(`gridTabPort`);
                }
            }

            function tabletPortrait(y){
                if(y.matches){
                    about.classList.remove(`gridTabLand`);
                    about.classList.add(`gridTabPort`);
                }
                else if(y > `750px`){
                    about.classList.remove(`gridTabPort`);
                    about.classList.add(`gridTabLand`);
                }
            }

            function tabletLandscape(x){
                if(x.matches){
                    about.classList.remove(`gridDesktop`);
                    about.classList.add(`gridTabLand`);
                }
                else if(x > `1080px`){
                    about.classList.remove(`gridTabLand`);
                    about.classList.add(`gridDesktop`);
                }
            }
            ...
            function desktop(a){
                if(a.matches){
                    about.classList.remove(`gridTabLand`);
                    about.classList.remove(`gridTabPort`);
                    // about.classList.remove(`gridMobileLand`);
                    about.classList.add(`gridDesktop`);
                }
                else if(a > `3000px`){
                    about.classList.remove(`gridDesktop`);
                    about.classList.add(`gridTV`);
                }
            }
