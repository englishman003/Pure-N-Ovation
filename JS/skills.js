    ...
    //  Functions
        ...
        // Mouse Hover Functions
            ...
            function mobilePortrait(z){
                if(z.matches){
                    skills.classList.remove(`gridTabPort`);
                    skills.classList.add(`gridMobilePort`);
                }
                else if(z > `500px`){
                    skills.classList.remove(`gridMobilePort`);
                    skills.classList.add(`gridTabPort`);
                }
            }

            function tabletPortrait(y){
                if(y.matches){
                    skills.classList.remove(`gridTabLand`);
                    skills.classList.add(`gridTabPort`);
                }
                else if(y > `750px`){
                    skills.classList.remove(`gridTabPort`);
                    skills.classList.add(`gridTabLand`);
                }
            }

            function tabletLandscape(x){
                if(x.matches){
                    skills.classList.remove(`gridDesktop`);
                    skills.classList.add(`gridTabLand`);
                }
                else if(x > `1080px`){
                    skills.classList.remove(`gridTabLand`);
                    skills.classList.add(`gridDesktop`);
                }
            }
            ...
            function desktop(a){
                if(a.matches){
                    skills.classList.remove(`gridTabLand`);
                    skills.classList.remove(`gridTabPort`);
                    // skills.classList.remove(`gridMobileLand`);
                    skills.classList.add(`gridDesktop`);
                }
                else if(a > `3000px`){
                    skills.classList.remove(`gridDesktop`);
                    skills.classList.add(`gridTV`);
                }
            }
